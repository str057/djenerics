...
class MailingAttempt(models.Model):
    ...
    client = models.ForeignKey('clients.Client', on_delete=models.CASCADE, null=True, blank=True, verbose_name='Клиент')
...
class Mailing(models.Model):
    ...
    def send_mailing(self):
        ...
        main_attempt = MailingAttempt.objects.create(
            mailing=self,
            status='started',
            server_response='Начало рассылки'
        )
        ...
        main_attempt.server_response = f'Успешно: {success_count}, Ошибок: {error_count}'
        main_attempt.save()
